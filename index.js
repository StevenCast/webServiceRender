...
//Configurar el servidor para decirle que este directorio es donde se guarda todos los templates
app.set("views", path.join(__dirname, "views"))

app.get("/", (req,res) => {
    res.send("Animal de granja")
})
...
app.get("/xd", (req,res) => {
    ...
    //res.sendDate("5/26/2024")

    //Enviar archivo mediante  res
    //path.join = une rutas no importa la sintaxis de ruta del sistema operativo
...
//Knowing the server is running xd
